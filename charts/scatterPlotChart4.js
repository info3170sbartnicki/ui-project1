export default function chart4() {
  ...
  // create buttons
  let button1 = d3.select("#scatterPlotChart4").append("div").attr("id", "button1");
  let button2 = d3.select("#scatterPlotChart4").append("div").attr("id", "button2");

  button1._groups[0][0].innerHTML = `
  <button>Departure Delay in Minutes</button>
  `;
  button2._groups[0][0].innerHTML = `
  <button>Arrival Delay in Minutes</button>
  `;
