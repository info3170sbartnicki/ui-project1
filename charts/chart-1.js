export default function lineChart() {
  ...
  const plotArea = svg.append('g').attr('transform', 'translate(50, 50)');
  ...
  d3.csv('./charts/data/customer_satisfaction.csv').then((data) => {
    ...
    circle
      ...
      .on('mouseover', (d, i) => {
        ...
        lineChartTip.transition().duration(50).style('opacity', 1);
        console.log('d: ', d);
      ...
      .on('mouseout', function (d, i) {
        ...
        lineChartTip.transition().duration('50').style('opacity', 0);
      });
